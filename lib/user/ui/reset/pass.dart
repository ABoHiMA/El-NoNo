...
import 'package:el_nono/user/ui/reset/username.dart';
  ...
  Widget build(BuildContext context) {
    ...
    return BlocConsumer<AppCubit, AppStates>(
      listener: (context, state) {
        if (state is AppUpdateDataUserSuccState) {
          pgx(context: context, nextPage: const UserLogin());
        }
      },
                ...
                child: SingleChildScrollView(
                  child: Column(
                    ...
                    children: [
                      ...
                      const SizedBox(height: 18),
                      tff(
                        text: local.repeat_new_password,
                        icon: Icons.lock_outline,
                        ctrl: ctrlRePass,
                        type: TextInputType.visiblePassword,
                        ...
                        vld: (val) {
                          if (val!.isEmpty) {
                            return local.enter_repeat_new_password;
                          }
                          return null;
                        },
                      ),
                      Align(
                        ...
                        child: TextButton(
                          onPressed: () {
                            pgn(
                                context: context,
                                nextPage: const UserResetUsername());
                          },
                          child: txt(
                            context: context,
