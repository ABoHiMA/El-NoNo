...
class UserResetUsername extends StatelessWidget {
  const UserResetUsername({super.key});
                  ...
                  child: Column(
                    ...
                    children: [
                      ...
                      tff(
                        ...
                        vld: (val) {
                          if (val!.isEmpty) {
                            return local.enter_new_username;
                          }
                          return null;
                        },
                      ),
