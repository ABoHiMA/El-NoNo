...
import 'package:el_nono/user/ui/layout/user_layout.dart';
import 'package:el_nono/user/ui/reset/pass.dart';
                        ...
                        tff(
                            ...
                            smt: (val) {
                              if (formkey.currentState!.validate()) {
                                if (userUsernameData == ctrlUsername.text) {
                                  if (userPassData == ctrlPass.text) {
                                    pgx(
                                        context: context,
                                        nextPage: const UserLayout());
                                  } else {
                                    setState(() {
                                      isCheck = false;
                                    });
                        ...
                        Align(
                          ...
                          child: TextButton(
                            onPressed: () {
                              pgn(
                                  context: context,
                                  nextPage: const UserResetPassword());
                            },
                            child: txt(
                              context: context,
